...
Usage
-----
    python scripts/show_study.py results/hypertune/study.db
    python scripts/show_study.py results/hypertune-my-study/study.db [--sort score]
"""
import argparse
import os
import sys
...
# Run from repo root so the editable install is on the path.
