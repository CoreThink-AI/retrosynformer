...
Usage
-----
    python scripts/show_all_studies.py
    python scripts/show_all_studies.py "results/**/study.db"
    python scripts/show_all_studies.py "results/hypertune-*/study.db" --sort score
"""
import argparse
import glob
import os
