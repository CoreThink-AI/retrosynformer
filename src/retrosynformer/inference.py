...
class RoutePredictor:
    def __init__(self, model, config, beam_width=None, prevent_cyclic_routes=True):
        ...
        if self.config["evaluation"].get("prevent_cyclic_routes", None) is not None:
            self.prevent_cyclic_routes = self.config["evaluation"].get("prevent_cyclic_routes", None)
